...
query = torch.randn((batch_size, 1, num_heads, head_size),
                    dtype=torch.bfloat16)
k_cache = torch.randn((num_kv_heads, num_blocks * block_size, head_size),
                      dtype=torch.bfloat16)
v_cache = torch.randn((num_kv_heads, num_blocks * block_size, head_size),
                      dtype=torch.bfloat16)
...
args = (query, k_cache, v_cache, context_lens, block_tables,
